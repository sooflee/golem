...
<p>The World Cup happens exactly once, and on any given day the better team can lose,
so a single prediction is mostly luck. Instead, I ask a question that actually has an
answer:
